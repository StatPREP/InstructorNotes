...
2. Open up one of the following links in the other browser window.
    - [One-file web site](https://github.com/StatPREP/one-page-website) uses only GitHub.
    - [Many-file web site](https://github.com/StatPREP/website-template) requires RStudio for editing.
